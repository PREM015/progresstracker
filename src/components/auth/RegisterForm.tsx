...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!acceptTerms) {
      setValidationErrors({ acceptTerms: "You must accept terms and privacy policy" });
      setLoading(false);
      return;
    }
    ...
    <div className="w-full max-w-110">
      <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
        ...
        <div className="text-center pt-8 pb-6 px-6">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-linear-to-br from-indigo-600 to-purple-600 rounded-2xl mb-4 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div>
              ...
              <input
                ...
                disabled={loading}
                autoComplete="name"
                className={`w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800/50 border ${validationErrors.name
            ...
            <div>
              ...
              <input
                ...
                disabled={loading}
                autoComplete="email"
                className={`w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800/50 border ${validationErrors.email
                  ? 'border-red-500 focus:ring-red-500'
                  : 'border-gray-300 dark:border-gray-700 focus:ring-indigo-500'
                  } rounded-xl focus:ring-2 focus:border-transparent dark:text-white placeholder-gray-400 transition duration-200 disabled:opacity-50 text-sm`}
              />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-2.5 pr-11 bg-gray-50 dark:bg-gray-800/50 border ${validationErrors.password
                    ? 'border-red-500 focus:ring-red-500'
                    : 'border-gray-300 dark:border-gray-700 focus:ring-indigo-500'
                    } rounded-xl focus:ring-2 focus:border-transparent dark:text-white placeholder-gray-400 transition duration-200 disabled:opacity-50 text-sm`}
                />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  disabled={loading}
                  autoComplete="new-password"
                  className={`w-full px-4 py-2.5 pr-11 bg-gray-50 dark:bg-gray-800/50 border ${validationErrors.confirmPassword
                    ? 'border-red-500 focus:ring-red-500'
                    : 'border-gray-300 dark:border-gray-700 focus:ring-indigo-500'
                    } rounded-xl focus:ring-2 focus:border-transparent dark:text-white placeholder-gray-400 transition duration-200 disabled:opacity-50 text-sm`}
                />
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <label htmlFor="acceptTerms" className="text-xs text-gray-700 dark:text-gray-300">
                I accept the <a href="#" className="text-indigo-600 dark:text-indigo-400 font-medium">Terms</a> and <a href="#" className="text-indigo-600 dark:text-indigo-400 font-medium">Privacy Policy</a>
              </label>
            </div>
            ...
            >{/* Accept Terms Checkbox */}
              ...
              {loading ? (
                <span className="flex items-center justify-center gap-2 p-32">
