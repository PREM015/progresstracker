 ...
 * Location: components/auth/ChangeEmailForm.tsx
 * 
...
// Example API calls:
// /api/auth/change-email
const fetchChangeEmailFormData = async () => {
  try {
...
const fetchChangeEmailFormData = async () => {
  try {
    const response = await apiClient.get('/api/auth/confirm-email-change');
    return response.data;
  } catch (error) {
    console.error('Error fetching data:', error);
    throw error;
 ...
 * - API: /api/auth/confirm-email-change
 *  * - Model: User
