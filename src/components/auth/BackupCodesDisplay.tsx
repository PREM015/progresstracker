 ...
 * Location: components/auth/BackupCodesDisplay.tsx
 * 
 * Description: Display and manage backup codes
 */
...
// Example API calls:
// /api/backup-codes
const fetchBackupCodesDisplayData = async () => {
  try {
    const response = await apiClient.get('/api/backup-codes');
