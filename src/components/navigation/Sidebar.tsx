  ...
  const navItems = [
    {
      ...
      items: [
        ...
        { href: DASHBOARD_ROUTES.PLATFORMS, label: 'Platforms', icon: Layers }, // Moved here or separate group
      ],
    },
    {
      group: 'Platforms',
    ...
    },
    {
      ...
      items: [
        ...
        { href: DASHBOARD_ROUTES.NOTIFICATIONS, label: 'Notifications', icon: Zap }, // Zap or Bell
        { href: DASHBOARD_ROUTES.SUPPORT, label: 'Support', icon: LogOut }, // LogOut is weird for support. Let's use HelpCircle if available, or just keep it active.
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-zinc-200/50 dark:border-zinc-800/50">
        {!collapsed ? (
          <Tilt3D intensity={5}>
            <GlowBorder className="relative overflow-hidden rounded-xl bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/30 dark:to-zinc-900/50 p-0.5 shadow-sm group/pro cursor-pointer hover:shadow-md transition-all">
              <div className="bg-white/50 dark:bg-black/20 p-4 h-full w-full rounded-[inherit] backdrop-blur-sm">
                <div className="absolute top-0 right-0 -mr-4 -mt-4 h-24 w-24 rounded-full bg-indigo-500/10 blur-xl group-hover/pro:bg-indigo-500/20 transition-all" />

                <div className="relative flex items-center gap-3">
                  <div className="h-10 w-10 rounded-lg bg-indigo-600 flex items-center justify-center text-white shadow-md shadow-indigo-500/20">
                    <Zap className="h-5 w-5 fill-current" />
                  </div>
                  <div className="flex-1">
                    <p className="text-sm font-bold text-zinc-900 dark:text-zinc-50">Pro Plan</p>
                    <div className="h-1.5 w-full bg-zinc-200 dark:bg-zinc-800 rounded-full mt-1.5 overflow-hidden">
                      <div className="h-full w-[70%] bg-indigo-500 rounded-full" />
                    </div>
                    <p className="text-[10px] text-zinc-500 mt-1">70% goals reached</p>
                  </div>
                </div>
              </div>
            </GlowBorder>
          ...
          <div className="flex justify-center">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20 cursor-pointer hover:scale-105 transition-transform">
              <Zap className="h-5 w-5 fill-current" />
            </div>
          </div>
        )}
