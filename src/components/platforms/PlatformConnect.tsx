 ...
 * Location: components/platforms/PlatformConnect.tsx
 * 
 * Description: Connect platform modal
 */
...
// Example API calls:
// /api/platforms/connect
const fetchPlatformConnectData = async () => {
  try {
...
const fetchPlatformConnectData = async () => {
  try {
    const response = await apiClient.get('/api/platforms/verify');
    return response.data;
  } catch (error) {
    console.error('Error fetching data:', error);
    throw error;
