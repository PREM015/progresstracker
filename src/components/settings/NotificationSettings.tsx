 ...
 * 
 * Description: All notification prefs
 */
...
// Interface for NotificationPreferences model
interface INotificationPreferences {
  id: string;
  // Add fields from your Prisma NotificationPreferences model
...
// Example API calls:
// /api/user/notifications
const fetchNotificationSettingsData = async () => {
  try {
