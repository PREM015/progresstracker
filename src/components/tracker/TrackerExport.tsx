/**
 * Component: TrackerExport
 * Location: components/tracker/TrackerExport.tsx
 * 
...
// Example API calls:
// /api/tracker/export
const fetchTrackerExportData = async () => {
  try {
    const response = await apiClient.get('/api/tracker/export');
