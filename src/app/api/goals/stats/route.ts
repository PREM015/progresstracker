// =============================================================================
// goals/stats/route.ts
// =============================================================================
// Description: Goal statistics overview
// Methods: GET
// Auth Required: True
// Rate Limit: 50 requests/minute
// Tags: goal, stats
// Generated: 2026-02-02T11:57:44.515479
// =============================================================================
 ...
 * TODO Implementation Checklist:
   ...
   * - Count goals by status (active, completed, failed, etc.)
   * - Calculate overall completion rate
   * - Get goals completed this week/month/year
   * - Calculate average goal duration
   * - Get most successful goal types/categories
   * - Calculate streak of consecutive goal completions
...
export async function GET(
  ...
  try {
    ...
    logger.info('GET goals/stats completed', {
      userId,
      page,
      total,
      requestId,
    ...
    logger.error('GET goals/stats failed', { requestId }, error);
