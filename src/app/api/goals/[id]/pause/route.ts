// =============================================================================
// goals/[id]/pause/route.ts
// =============================================================================
// Description: Pause goal
// Methods: POST
// Auth Required: True
// Rate Limit: 20 requests/minute
// Tags: goal, status
// Generated: 2026-02-02T11:57:44.520984
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `goals-[id]-pause:${ip}`;
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST goals/[id]/pause completed', {
      userId,
      requestId,
    ...
    logger.error('POST goals/[id]/pause failed', { requestId }, error);
