...
// Tags: goal, status
// Generated: 2026-02-02T11:57:44.522868
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `goals-[id]-cancel:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Check goal can be cancelled (not already completed/cancelled)
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST goals/[id]/cancel completed', {
      userId,
      requestId,
    ...
    logger.error('POST goals/[id]/cancel failed', { requestId }, error);
