// =============================================================================
// goals/categories/route.ts
// =============================================================================
// Description: Goals by category
// Methods: GET
// Auth Required: True
// Rate Limit: 50 requests/minute
// Tags: goal, category
// Generated: 2026-02-02T11:57:44.518131
// =============================================================================
 ...
 * TODO Implementation Checklist:
   ...
   * - Group user's goals by category
   * - Calculate stats per category (count, completion rate)
   * - Include active goals per category
   * - Return categories with goal summaries
 */
export async function GET(
  ...
  try {
    ...
    logger.info('GET goals/categories completed', {
      userId,
      page,
      total,
      requestId,
    ...
    logger.error('GET goals/categories failed', { requestId }, error);
