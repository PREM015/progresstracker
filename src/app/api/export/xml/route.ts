...
// Tags: export, xml
// Generated: 2026-02-02T11:57:44.630885
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `export-xml:${ip}`;
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST export/xml completed', {
      userId,
      requestId,
    ...
    logger.error('POST export/xml failed', { requestId }, error);
