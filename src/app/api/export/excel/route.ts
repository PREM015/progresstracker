...
// Tags: export, excel
// Generated: 2026-02-02T11:57:44.630402
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `export-excel:${ip}`;
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST export/excel completed', {
      userId,
      requestId,
    ...
    logger.error('POST export/excel failed', { requestId }, error);
