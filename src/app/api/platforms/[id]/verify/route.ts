// =============================================================================
// platforms/[id]/verify/route.ts
// =============================================================================
// Description: Verify specific platform connection
// Methods: POST
// Auth Required: True
// Rate Limit: 20 requests/minute
// Tags: platform, verification
// Generated: 2026-02-02T11:57:44.512302
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `platforms-[id]-verify:${ip}`;
...
/**
 * POST - Verify specific platform connection
 * 
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST platforms/[id]/verify completed', {
      userId,
      requestId,
    ...
    logger.error('POST platforms/[id]/verify failed', { requestId }, error);
