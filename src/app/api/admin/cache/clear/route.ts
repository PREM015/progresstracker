...
// Tags: admin, cache, system
// Generated: 2026-02-02T11:57:44.538335
// =============================================================================
...
async function validateAdminSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `admin-cache-clear:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Parse cache key pattern from request body
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST admin/cache/clear completed', {
      userId,
      requestId,
    ...
    logger.error('POST admin/cache/clear failed', { requestId }, error);
...
export async function DELETE(
  ...
  try {
    ...
    logger.info('DELETE admin/cache/clear completed', {
      userId,
      requestId,
      duration: Date.now() - startTime,
    });
    ...
    logger.error('DELETE admin/cache/clear failed', { requestId }, error);
    return addHeaders(apiResponse.internalError('Operation failed', requestId), requestId);
  }
}
