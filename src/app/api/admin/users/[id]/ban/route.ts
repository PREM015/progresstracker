...
// Generated: 2026-02-02T11:57:44.525018
// =============================================================================
...
async function validateAdminSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `admin-users-[id]-ban:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Prevent self-ban
   * - Update user.isBanned to true
   * - Set user.bannedAt timestamp
   * - Set user.bannedBy to admin ID
   * - Store ban reason from request body
   * - Revoke all user's active sessions
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST admin/users/[id]/ban completed', {
      userId,
      requestId,
    ...
    logger.error('POST admin/users/[id]/ban failed', { requestId }, error);
