// =============================================================================
// admin/users/[id]/verify/route.ts
// =============================================================================
// Description: Manually verify user
// Methods: POST
// Auth Required: True
// Admin Only: True
// Rate Limit: 20 requests/minute
// Tags: admin, user, verification
// Generated: 2026-02-02T11:57:44.530258
// =============================================================================
...
async function validateAdminSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `admin-users-[id]-verify:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Delete pending EmailVerification records
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST admin/users/[id]/verify completed', {
      userId,
      requestId,
    ...
    logger.error('POST admin/users/[id]/verify failed', { requestId }, error);
