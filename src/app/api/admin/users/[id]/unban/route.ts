...
// Generated: 2026-02-02T11:57:44.525935
// =============================================================================
...
async function validateAdminSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `admin-users-[id]-unban:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Check user is currently banned
   * - Update user.isBanned to false
   * - Clear bannedAt, bannedBy, banReason
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST admin/users/[id]/unban completed', {
      userId,
      requestId,
    ...
    logger.error('POST admin/users/[id]/unban failed', { requestId }, error);
