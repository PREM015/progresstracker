...
// Generated: 2026-02-02T11:57:44.552717
// =============================================================================
...
async function validateAdminSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `admin-permissions:${ip}`;
...
export async function GET(
  ...
  try {
    ...
    logger.info('GET admin/permissions completed', {
      userId,
      page,
      total,
      requestId,
    ...
    logger.error('GET admin/permissions failed', { requestId }, error);
