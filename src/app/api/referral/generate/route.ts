// =============================================================================
// referral/generate/route.ts
// =============================================================================
// Description: Generate referral code
// Methods: POST
// Auth Required: True
// Rate Limit: 5 requests/minute
// Tags: referral, generate
// Generated: 2026-02-02T11:57:44.606455
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `referral-generate:${ip}`;
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST referral/generate completed', {
      userId,
      requestId,
    ...
    logger.error('POST referral/generate failed', { requestId }, error);
