...
// Tags: system, config
// Generated: 2026-02-02T11:57:44.620457
// =============================================================================
 ...
 * TODO Implementation Checklist:
   * - Get SystemSettings where isPublic=true
   * - Include supported platforms list
   * - Include UI configuration
   * - Return public config object
   * - Cache response
 */
export async function GET(
  ...
  try {
    ...
    logger.info('GET config completed', {
    ...
    logger.error('GET config failed', { requestId }, error);
