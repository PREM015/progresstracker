// =============================================================================
// sync/[platformId]/force/route.ts
// =============================================================================
// Description: Force sync for platform
// Methods: POST
// Auth Required: True
// Rate Limit: 5 requests/minute
// Tags: sync, force
// Generated: 2026-02-02T11:57:44.573459
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `sync-[platformId]-force:${ip}`;
...
/**
 * POST - Force sync for platform
 * 
 * TODO Implementation Checklist:
   * - Validate session and platform ownership
   * - Bypass normal sync scheduling
   * - Clear cached data for platform
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST sync/[platformId]/force completed', {
      userId,
      requestId,
    ...
    logger.error('POST sync/[platformId]/force failed', { requestId }, error);
