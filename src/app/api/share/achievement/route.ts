// =============================================================================
// share/achievement/route.ts
// =============================================================================
// Description: Share achievement
// Methods: POST
// Auth Required: True
// Rate Limit: 30 requests/minute
// Tags: share, achievement
// Generated: 2026-02-02T11:57:44.604679
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `share-achievement:${ip}`;
 ...
 * TODO Implementation Checklist:
   * - Validate session and achievement ownership
   * - Parse achievement ID from request
   * - Generate shareable image/card
   * - Create share record
   * - Return share URL and image URL
 */
export async function POST(
  ...
  try {
    ...
    logger.info('POST share/achievement completed', {
      userId,
      requestId,
    ...
    logger.error('POST share/achievement failed', { requestId }, error);
