...
// Tags: share, public
// Generated: 2026-02-02T11:57:44.603421
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `share-[code]:${ip}`;
 ...
 * TODO Implementation Checklist:
   * - Parse share code from URL params
   * - Find share record by code
   * - Check if share has expired
   * - Check access restrictions
   * - Get shared entity data
   * - Increment view count
   * - Return shared content (sanitized)
 */
export async function GET(
  request: NextRequest, { params }: { params: Promise<{ code: string }> }
  ...
  try {
    ...
    logger.info('GET share/[code] completed', {
    ...
    logger.error('GET share/[code] failed', { requestId }, error);
