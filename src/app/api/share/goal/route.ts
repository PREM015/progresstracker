...
// share/goal/route.ts
// =============================================================================
// Description: Share goal
// Methods: POST
// Auth Required: True
// Rate Limit: 20 requests/minute
// Tags: share, goal
// Generated: 2026-02-02T11:57:44.604114
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `share-goal:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Parse goal ID from request
   * - Generate share code
   * - Update goal.isPublic and shareCode
   * - Return share URL
 */
export async function POST(
  ...
  try {
    ...
    logger.info('POST share/goal completed', {
      userId,
      requestId,
    ...
    logger.error('POST share/goal failed', { requestId }, error);
