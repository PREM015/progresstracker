...
// Tags: search, global
// Generated: 2026-02-02T11:57:44.592920
// =============================================================================
 ...
 * TODO Implementation Checklist:
   ...
   * - Parse search query and type filter
   * - Search across multiple entities (goals, entries, achievements)
   * - Weight results by relevance
   * - Support advanced search operators
   * - Return categorized search results
   * - Include result counts per category
 */
export async function GET(
  ...
  try {
    ...
    logger.info('GET search completed', {
      userId,
      page,
      total,
      requestId,
