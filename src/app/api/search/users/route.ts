...
// =============================================================================
// Description: Search public users
// Methods: GET
// Auth Required: False
// Rate Limit: 50 requests/minute
// Tags: search, user
// Generated: 2026-02-02T11:57:44.594951
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `search-users:${ip}`;
...
export async function GET(
  ...
  try {
    ...
    logger.info('GET search/users completed', {
    ...
    logger.error('GET search/users failed', { requestId }, error);
