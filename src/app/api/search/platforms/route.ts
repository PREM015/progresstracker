...
// Generated: 2026-02-02T11:57:44.595611
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `search-platforms:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Search platform names and descriptions
...
export async function GET(
  ...
  try {
    ...
    logger.error('GET search/platforms failed', { requestId }, error);
