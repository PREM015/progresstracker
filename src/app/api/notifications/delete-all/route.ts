// =============================================================================
// notifications/delete-all/route.ts
// =============================================================================
...
// Generated: 2026-02-02T11:57:44.621171
// =============================================================================
...
const CORS_HEADERS = {
  ...
  'Access-Control-Allow-Methods': 'DELETE, POST, OPTIONS, HEAD',
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `notifications-delete-all:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Soft delete or archive notifications
...
export async function DELETE(
  ...
  try {
    ...
    logger.info('DELETE notifications/delete-all completed', {
      userId,
      requestId,
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST notifications/delete-all completed', {
      userId,
      requestId,
      duration: Date.now() - startTime,
    });
    ...
    logger.error('POST notifications/delete-all failed', { requestId }, error);
    return addHeaders(apiResponse.internalError('Operation failed', requestId), requestId);
  }
}
