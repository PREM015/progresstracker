// =============================================================================
// webhooks/email/complaint/route.ts
// =============================================================================
// Description: Handle spam complaint webhook
// Methods: POST
// Auth Required: False
// Rate Limit: 100 requests/minute
// Tags: webhook, email, complaint
// Generated: 2026-02-02T11:57:44.615375
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `webhooks-email-complaint:${ip}`;
...
export async function POST(
  ...
  try {
    ...
    logger.error('POST webhooks/email/complaint failed', { requestId }, error);
