// =============================================================================
// stripe/usage/route.ts
// =============================================================================
// Description: Get subscription usage data
// Methods: GET
// Auth Required: True
// Rate Limit: 50 requests/minute
// Tags: stripe, usage, subscription
// Generated: 2026-02-02T11:57:44.609656
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `stripe-usage:${ip}`;
...
/**
 * GET - Get subscription usage data
 * 
...
export async function GET(
  ...
  try {
    ...
    logger.info('GET stripe/usage completed', {
      userId,
      page,
      total,
      requestId,
