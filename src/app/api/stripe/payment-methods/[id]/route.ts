// =============================================================================
// stripe/payment-methods/[id]/route.ts
// =============================================================================
// Description: Manage specific payment method
// Methods: GET, PUT, DELETE
// Auth Required: True
// Rate Limit: 30 requests/minute
// Tags: stripe, payment
// Generated: 2026-02-02T11:57:44.611011
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `stripe-payment-methods-[id]:${ip}`;
...
/**
 * GET - Manage specific payment method
 * 
 * TODO Implementation Checklist:
   * - Validate session and payment method ownership
   * - GET: Get payment method details
   * - PUT: Update payment method (set as default)
   * - DELETE: Detach payment method from customer
   * - Prevent deleting last payment method if subscribed
...
export async function GET(
  ...
  try {
    ...
    logger.info('GET stripe/payment-methods/[id] completed', {
      userId,
      page,
      total,
      requestId,
    ...
    logger.error('GET stripe/payment-methods/[id] failed', { requestId }, error);
    return addHeaders(apiResponse.internalError('Operation failed', requestId), requestId);
  }
}

/**
 * PUT - Manage specific payment method
 * 
 * TODO Implementation Checklist:
   * - Validate session and payment method ownership
   * - GET: Get payment method details
...
export async function PUT(
  ...
  try {
    ...
    logger.info('PUT stripe/payment-methods/[id] completed', {
      userId,
      requestId,
      duration: Date.now() - startTime,
    });
    ...
    logger.error('PUT stripe/payment-methods/[id] failed', { requestId }, error);
    return addHeaders(apiResponse.internalError('Operation failed', requestId), requestId);
  }
}

/**
 * DELETE - Manage specific payment method
 * 
 * TODO Implementation Checklist:
   * - Validate session and payment method ownership
   * - GET: Get payment method details
...
export async function DELETE(
  ...
  try {
    ...
    logger.info('DELETE stripe/payment-methods/[id] completed', {
      userId,
      requestId,
      duration: Date.now() - startTime,
    });
    ...
    logger.error('DELETE stripe/payment-methods/[id] failed', { requestId }, error);
    return addHeaders(apiResponse.internalError('Operation failed', requestId), requestId);
  }
}
