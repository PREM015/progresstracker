...
// Tags: report, monthly
// Generated: 2026-02-02T11:57:44.627411
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `reports-monthly:${ip}`;
...
export async function GET(
  ...
  try {
    ...
    logger.info('GET reports/monthly completed', {
      userId,
      page,
      total,
      requestId,
    ...
    logger.error('GET reports/monthly failed', { requestId }, error);
