...
// Tags: report, custom
// Generated: 2026-02-02T11:57:44.628857
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `reports-custom:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Return report or queue generation
 */
export async function POST(
  ...
  try {
    ...
    logger.info('POST reports/custom completed', {
      userId,
      requestId,
    ...
    logger.error('POST reports/custom failed', { requestId }, error);
