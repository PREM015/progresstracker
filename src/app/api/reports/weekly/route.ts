...
// Tags: report, weekly
// Generated: 2026-02-02T11:57:44.626425
// =============================================================================
...
async function validateSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `reports-weekly:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Parse week from query params (default: last week)
   * - Get or generate Report record
   * - Calculate week's statistics
   * - Include comparisons with previous week
   * - Return report data
 */
export async function GET(
  ...
  try {
    ...
    logger.info('GET reports/weekly completed', {
      userId,
      page,
      total,
      requestId,
    ...
    logger.error('GET reports/weekly failed', { requestId }, error);
