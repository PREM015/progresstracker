...
// Generated: 2026-02-02T11:57:44.585866
// =============================================================================
...
async function validateAdminSession(request: NextRequest, requestId: string) {
  ...
  const rateLimitKey = `cron-monthly-report:${ip}`;
 ...
 * TODO Implementation Checklist:
   ...
   * - Get users with monthly report enabled
   * - Calculate month's statistics per user
...
export async function POST(
  ...
  try {
    ...
    logger.info('POST cron/monthly-report completed', {
      userId,
      requestId,
    ...
    logger.error('POST cron/monthly-report failed', { requestId }, error);
