...
// Tags: user, activity, audit
// Generated: 2026-02-02T11:57:44.501508
// =============================================================================
 ...
 * TODO Implementation Checklist:
   ...
   * - Parse pagination params (page, limit, cursor)
   * - Parse filter params (action type, date range, category)
   * - Query AuditLog for user's activities
   * - Include related entities (goals, platforms, etc.)
   * - Format activity items with human-readable descriptions
   * - Group activities by date if requested
   * - Calculate activity statistics (most active days, etc.)
   * - Return paginated activity list with metadata
...
export async function GET(
  ...
  try {
    ...
    logger.info('GET user/activity completed', {
      userId,
      page,
      total,
      requestId,
    ...
    logger.error('GET user/activity failed', { requestId }, error);
