...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const rateLimitResult = await checkLimit(apiRateLimiter, RATE_LIMIT, `leaderboard:monthly:${ip}`);
    ...
    logger.info('GET monthly leaderboard completed', { page, total, requestId, duration: Date.now() - startTime });
    ...
    logger.error('GET monthly leaderboard failed', { requestId }, error);
